    ...
    return Selector<SourcesModel, RSSSource>(
      ...
      builder: (context, source, child) {
        ...
        final openTarget = ListTileGroup.fromOptions(
          [
            Tuple2(AppLocalizations.of(context).rssText, SourceOpenTarget.Local),
            Tuple2(AppLocalizations.of(context).loadFull, SourceOpenTarget.FullContent),
            Tuple2(AppLocalizations.of(context).loadWebpage, SourceOpenTarget.Webpage),
            Tuple2(AppLocalizations.of(context).openExternal, SourceOpenTarget.External),
          ],
          source.openTarget,
          (v) {
            var cloned = source.clone();
